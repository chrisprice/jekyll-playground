...
To be clear, these aren’t the requirements of an average user, **Wordpress is an excellent tool for most** and Jekyll too is not without its downsides. Not least of which the very lengthy Window’s install process, the “quirky” capabilities of its categories/tags/pagination, inconsistencies in its object model and questions over its maintenance - but I’ll save all these for another post. It’s just that for me, as a developer, Jekyll permits a process and tooling that I’m far more comfortable with for a simple site.